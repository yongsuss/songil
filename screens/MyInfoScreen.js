  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.inputRow}>
        ...
        <Button title="수정" onPress={checkNicknameAvailability} />
      </View>
      <View style={styles.inputRow}>
      ...
      />
      <Button title="주소 수정" onPress={updateAddress} />
    </ScrollView>
  );
};
